function acc_mem_list(_win, _dom, param){
    ...
    _self.initEvent = function (ArrObj, div_show) {
        ...
        for (var i = 0; i < e; i++) {
            ...
            var obj_ids = ",span_credit,span_enable,btn_edit,btn_unlock,btn_user,change_credits_box,change_ip_box,change_seturl_box,change_status_box,span_ip,span_seturl,change_hide_user_box,";
