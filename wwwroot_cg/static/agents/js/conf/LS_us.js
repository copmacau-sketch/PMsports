function LS_us() {
    ...
    _self.set = function () {
	    ...
	    array["page_problem_accounts"] = "Flagged Accounts";
        array["page_announcement"] = "Announcement";
        array["page_account"] = "A/C Mgmt";
        array["page_su"] = "MASTER AGENTS";
        array["page_ag"] = "AGENTS";
        array["page_mem"] = "MEMBERS";
        array["page_sub"] = "SUB ACCOUNTS";
        ...
        array["page_acc_mem_modal"] = "Templates";
        array["page_acc_mem_createm_modal"] = "CREATE TEMPLATE";
        array["page_acc_mem_copym_modal"] = "CREATE TEMPLATE";
        array["page_acc_mem_editm_modal"] = "EDIT TEMPLATE";
        array["su_add"] = "New MA";
        array["ag_add"] = "New Agent";
        array["mem_add"] = "New Member";

        array["str_copied"] = "The data has been copied.";
        array["str_copy_err"] = "Your browser does not support this function, please directly paste the image on the screen or long-press the QR code to copy.";
        array["noliveChat"] = "Sorry, there seems to be an issue connecting. Please try again.";

        array["page_overview"] = "Overview";
        array["page_INPLAY"] = "In Progress";
        array["page_TODAY"] = "Today";
        array["page_EARLY"] = "Upcoming";
        array["page_STARTED"] = "Live";
        array["page_PARLAY"] = "Parlay";
        array["page_OUTRIGHT"] = "Outright";
        array["page_RESULTS"] = "Outcomes";
        ...
        array["period_not_set"] = "\"This Period\" is not set."
        array["overView_inc_yes"] = "increase from previous day";
        array["overView_dec_yes"] = "decrease from previous day";
        array["overView_inc_lw"] = " increase from previous week";
        array["overView_dec_lw"] = "decrease previous week";
        array["overView_inc_tp"] = "increase from previous period";
        array["overView_dec_tp"] = "decrease previous period";
        ...
        array["no_upper_add"] = "Please add an upper-level account before creating a sub-level account.";
        //快速搜尋
