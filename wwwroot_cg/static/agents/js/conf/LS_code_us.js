function LS_code_us(){
    ...
    _self.set=function(){
        ...
        ary["4X011"] = "1. Safe Code must be between 8 - 16 alphanumeric characters with at least 1 upper (A - Z) and lowercase letters (a - z) and at least 1 numeric character (0 - 9).</br>2. Safe Code must contain at least 3 different alphanumeric characters.</br>3. Safe Code must NOT contain any spaces.";
        ary["4X011_mem"] = "Your Safe Code must:</br>1. Be between 6 - 12 alphanumeric characters with at least 2 upper (A - Z) or lowercase letters (a - z) and at least 1 numeric characters (0 - 9).</br>2. Contain at least 3 different alphanumeric characters.</br>3. Not contain any spaces.";
        ...
        ary["4X021"] = "1. Password must be between 8 - 16 alphanumeric characters with at least 1 upper (A - Z) and lowercase letters (a - z) and at least 1 numeric character (0 - 9).</br>2. Password must contain at least 3 different alphanumeric characters.</br>3. Password must NOT contain any spaces.";
        // ary["4X021_mem"] = "Your Password must:</br>1. Be between 6 - 12 alphanumeric characters with at least 2 upper (A - Z) or lowercase letters (a - z) and at least 1 numeric characters (0 - 9).</br>2. Contain at least 3 different alphanumeric characters.</br>3. Not contain any spaces.";
        ary["4X021_mem"] = "1. Password must be between 6 - 12 alphanumeric characters with at least 2 upper (A - Z) or lowercase letters (a - z) and at least 1 numeric characters (0 - 9).</br>2. Password must contain at least 3 different alphanumeric characters.</br>3. Password must NOT contain any spaces.";
