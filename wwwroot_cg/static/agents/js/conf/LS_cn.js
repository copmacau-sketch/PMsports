function LS_cn() {
    ...
    _self.set = function () {
        ...
        array["page_totalbet"] = "实时下注";
        array["page_match"] = "事件操作";
        array["page_bet"] = "注单管理";
        array["page_set"] = "有结果";
        array["page_un"] = "未有结果";
        array["page_summary"] = "事件结果概要";
	    ...
	    array["page_problem_accounts"] = "异常账号";
        ...
        array["page_mem_add"] = "新会员";
        array["page_sub_add"] = "新增子帐号";//New Sub Agent
        array["page_acc_mem_modal"] = "模版";
        array["page_acc_mem_createm_modal"] = "创建模板";
        array["page_acc_mem_copym_modal"] = "创建模板";
        array["page_acc_mem_editm_modal"] = "编辑模版";
        array["su_add"] = "新总代";
        array["ag_add"] = "新代理";
        array["mem_add"] = "新会员";
        ...
        array["str_copy_err"] = "您的浏览器不支援此功能，请直接萤幕截图或是长按二维码复制。";
        array["noliveChat"] = "为您载入客服对话视窗时遇到些问题，请再试一次。";

        array["page_overview"] = "总览";
        array["page_INPLAY"] = "进行中";
        array["page_TODAY"] = "今日";
        array["page_EARLY"] = "未开始";
        array["page_STARTED"] = "已开始";
        array["page_PARLAY"] = "过关";
        array["page_OUTRIGHT"] = "冠军";
        array["page_RESULTS"] = "结果";
        array["page_MATCH"] = "事件列表";
        array["page_SCORE"] = "比分";
        ...
        array["overView_dec_yes"] = "比前一天减少";
        array["overView_inc_lw"] = "比上周增加";
        array["overView_dec_lw"] = "比上周减少";
        array["overView_inc_tp"] = "比上期增加";
        array["overView_dec_tp"] = "比上期减少";
        ...
        array["no_upper_add"] = "请先添加上层帐号后，再新增下层帐号。";
        //快速搜寻
