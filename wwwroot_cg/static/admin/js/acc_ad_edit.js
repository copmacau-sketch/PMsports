function acc_ad_edit(_win, _dom, paramObj){
    var _self = this;
    var level = "ad";
    var win = _win;
    var dom = _dom;
    ...
    var param;
    var acc_div = new Array("div_acc_detail","div_acc_power","div_acc_report","div_acc_eventlog","div_acc_onlineMem");
    var acc_title = new Object();
    acc_title["title"] = new Array("acc_detail","acc_power","acc_report","acc_eventlog","acc_onlineMem");
    var ObjEditNow;
    ...
    _self.init=function(){
        ...
        var obj_ids = ",div_acc_detail,div_acc_power,div_acc_report,div_acc_eventlog,div_acc_onlineMem,";
        obj_ids += "acc_detail,acc_power,acc_report,acc_eventlog,acc_onlineMem,"
    ...
    _self.openDiv = function(name){
        ...
        paramHash["edit_id"] = param.user_id;
