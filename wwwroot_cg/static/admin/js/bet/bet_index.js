function bet_index(_win, _dom,_toppar){
    var _self = this;
    var win = _win;
    var dom = _dom;
    var parentClass;
    var classname = "bet_index";
    var util;
    var LS;
    var config_set;
    var Timer;
    ...
    _self.loadFinish=function(json){
        ...
        for(var prop in allwagers){
            ...
            if(!_self.chkCanParse(gtype,stake,downline,market,league,_event,dates))	continue;
...
//console.log(outStr_small);
    ...
    _self.chkCanParse=function(gtype,stake,downline,market,league,_event,dates){
...
//=====
    ...
    _self.setSelectEvent=function(){
        ...
        if(filterBigObj==null){
            ...
            var tmpObj = new Object();
            var tmpAry = ["league","event","downline","dates"];
