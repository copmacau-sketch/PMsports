function bet_header(_win, _dom, _toppar){
    ...
    var toppar = _toppar;
    var showtypeAry = new Array("LIST","EDIT","ABNORMAL","LIVE");
    ...
    _self.chgShowType = function (e, param) {
        ...
        if(toppar["bet_showtype"] == "EDIT"){
            toppar["sub_page"] = "bet_edit_index";
        }else if(toppar["bet_showtype"] == "SCORE"){
    ...
    _self.getTbetIndex = function (par,isInit) {
        ...
        if(isInit){
            ...
            if(par["bet_showtype"] == "EDIT"){
                param["page"] = "bet_edit_index";
            }else{
                param["page"] = "bet_index";
            }
            //param["page"] = "bet_index";
