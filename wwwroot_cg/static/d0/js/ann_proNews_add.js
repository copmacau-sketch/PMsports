function ann_proNews_add(_win, _dom, paramObj){
    var _self = this;
    var level ="proNews";
    var win = _win;
    var dom = _dom;
    ...
    _self.init=function() {
        ...
        obj_ids += "box_content,input_content,input_tel,msg_content,";
        ...
        ctlObj["tel"].box = _mc["box_content"];
        ctlObj["tel"].msg = _mc["msg_content"];
        ...
        if(param.hasOwnProperty("username")){
            _mc["input_user"].value = param.username;
        }
    ...
    _self.submitCheck = function () {
        ...
        if (ctlObj["tel"].input.value == "") {
            _self.showErrorCtl("tel", LS.get("empty_content"));
            return false;
        }
