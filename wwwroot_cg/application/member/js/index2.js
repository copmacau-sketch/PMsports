function index(_win, _dom) {
   ...
   _self.getMemData = function(data){
        if(data!=""){
            ...
            var msg = data.msg;
			if (msg) {
				document.querySelector('#msgcon').innerHTML = msg;
				//console.log('msg:'+msg);
				document.querySelector('.web_notice').style.display = '';
			} else {
			...
			var intervalId = setInterval(function() {  
                            ...
                            if (backcount >= 5) {
                                ...
                                if (win._history.length > 1) {
                                    ...
                                    try {
                                        ...
                                        if (hash.postHash.gtype)
                                            top.choice_gtype = hash.postHash.gtype;
                ...
                _self.removebodylock = function(param) {
                    ...
                    if (!announcementlock) {
                        ...
                        if (ios) {
                            console.log("\u95dc\u9589\u80cc\u666f\u9396\u5b9a", nowScrollTop);
                ...
                _self.lockbottom = function() {
                    var alllock = new Array("menu_tv","header_tv","home_page","live_page","today_page","early_page","parlay_page","special_page","outrights_page","menu_myGame","header_myGame","soon_page","hot_page");
