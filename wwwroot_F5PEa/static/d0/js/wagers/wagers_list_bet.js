function wagers_list_bet(_win, _dom, paramObj){
    ...
    _self.parseData = function(data){
        ...
        if(row0){
            ...
            var subDataAry = new Array("DATE","TIME","NAME0","M_TYPE","TD_CONTENT","IN_RADIO","ODDF_TYPE","TID","TID","GT","SRV_IP","TNAME","BALL_ACT","GOLD","ARESULT","SRESULT","CRESULT","D0RESULT","CANCEL_MSG");
            for (var i = s; i < e; i++) {
                tpl.addBlock("row0");
