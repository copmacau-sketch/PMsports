            ...
            if (arr_data["code"] == "none"){
                ...
                for (var i = 0, len = mesgAry.length; i < len; i++) {
                    ...
                    if(exStr.indexOf("proNews") != -1){
                        ...
                        editadd ='<span class="btn_edit" id="btn_edit"><i class="icon_edit"></i></span> <span class="btn_dele" id="btn_dele"><i class="icon_dele"></i></span>';
                        tmpTr = tmpTr.replace("*EDITDELE*", editadd);
