function BK_result_detail(_win, _dom, _post) {
    var classname = "BK_result_detail";
    var _self = this;
    var win = _win;
    var dom = _dom;
    var parentClass;
    ...
    _self.parseData = function (obj) {
        ...
        var score_type = Array("GMH3", "GMH4", "GMH5", "GMH6", "GMH1", "GMH2", "HGMH", "GMH");

        for (var i = 0; i < score_type.length; i++) {
            tpl.addBlock("game");

            var time_slot = LS.get("str_BK_" + i);
            var score_h = 0;
            var score_c = 0;
            ...
            if (score_type[i] in gameData) {
                ...
                if (gameData[score_type[i]]["result_h"] == "") score_h = "-";
                if (gameData[score_type[i]]["result_c"] != undefined) score_c = gameData[score_type[i]]["result_c"];
                if (gameData[score_type[i]]["result_c"] == "") score_c = "-";
            } else {
