function acc_ag_detail(_win, _dom, paramObj){
    var _self = this;
    var level = "ag";
    var win = _win;
    var dom = _dom;
    ...
    _self.upd_data = function(e){
        ...
        if( (new_enddate != acc_par.enddate) || (new_alias != acc_par.alias) || (new_credits*1 != acc_par.maxcredit*1) || (new_status != acc_par.status) || (new_psw_recv != acc_par.psw_enable) || (new_winloss_a != acc_par.dfwinloss_a)||(new_winloss_s != acc_par.dfwinloss_s) ){
