function acc_co_list(_win, _dom, param){
    var _self = this;
    var supLevel = "d0";
    var level = "co";
    var subLevel = "su";
        ...
        try {
            ...
            if (arr_data["account"].length > 0) {
                ...
                for (var i = 0; i < e; i++) {
                    ...
                    contanttmp = contanttmp.replace(/\*PASSWD_SAFE\*/g, util.showTxt(obj["passwd_safe"]));
    ...
    _self.editEventPrev = function (mouseEvent, _param) {
        ...
        var tmp_obj = {};
        tmp_obj.user_id = _param.user_id;
