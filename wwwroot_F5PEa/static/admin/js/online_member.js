function online_member(_win, _dom){
    ...
    _self.parseData = function (hash) {
        ...
        var memAry = new Array("memcount","username","loginname","alias","lastdate","id","onlines","gray","suplist");
                                ...
                                if (hash[i]["ip"]) {
                                    if (hash[i]["ip"] != "" && hash[i]["ip"] != "-") {
                                        ...
                                        if (hash[i]["onlines"]["log"] && hash[i].hasOwnProperty("sp")) {
                                            ...
                                            var kk = '<tt id="btn_small_sp" class="word_blue hand">不相同</tt>';
                                            if (hash[i]["sp"] == 1) {
                                                kk = '<tt id="btn_small_sp" class="word_red hand">相同</tt>';
                                            }
                                            str_small += kk + '</span>';
                                        }
    ...
    _self.getGrayTb = function() {
        //console.log(666);
        //var tb = document.getElementById('re_table_body_one');
        //var rows = tb.rows;
        //console.log(tb);
    }
}