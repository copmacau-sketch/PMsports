function acc_ad_list(_win, _dom, param){
    var _self = this;
    var level = "ad";
    var win = _win;
    var dom = _dom;
        ...
        try {
            ...
            if (arr_data["account"].length > 0) {
                ...
                for (var i = 0; i < e; i++) {
                    ...
                    contanttmp = contanttmp.replace(/\*LEVEL\*/g, util.showTxt(obj["level"]));
                    contanttmp = contanttmp.replace(/\*LOWER_D0_COUNT\*/g, util.showTxt(obj["lower_d0_count"]));
    ...
    _self.initEvent = function (ArrObj, div_show) {
        ...
        for (var i = 0; i < e; i++) {
            ...
            var obj_ids = ",span_credit,span_enable,btn_edit,btn_add,btn_dele,btn_unlock,btn_user,change_credits_box,change_status_box,";
        ...
        var objids = ",title_username,title_alias,title_maxcredit,title_d0_count,title_co_count,title_su_count,title_ag_count,title_mem_count,title_adddate,";
    ...
    _self.saveEvent = function (mouseEvent, account) {
        ...
        if (account.saveType == "credits") {
            ...
            sendCode = "p=chg_"+level+ "_credit&" + _self.getBaseParam() + "&" + sendCode;
    ...
    //edit
    _self.editEventPrev = function (mouseEvent, _param) {
        parentClass.dispatchEvent("showLoading", { "showLoading": true });
        var getHttp = new HttpRequest();
        getHttp.addEventListener("LoadComplete", _self.editEvent);
        var tmp_obj = {};
        tmp_obj.id = _param.id;
        tmp_obj.user_id = _param.id;
        tmp_obj.username = _param.username;
        tmp_obj.layer = "ad";
        tmp_obj.user_type = _param.user_type;
        tmp_obj.enable = _param.enable;
        var txt = JSON.stringify(tmp_obj)
