function top_menu(_win, _dom) {
    ...
    var ads_layer = {"ad":6,"d0":5,"co":4,"su":3,"ag":2,"mem":1};
    var ad_layer = {"d0":5,"co":4,"su":3,"ag":2,"mem":1};
        ...
        if(param.url_hash!=null){
            ...
            for (var i = 0, len = group_name.length ; i < len ; i++){
                ...
                if (layer[key]){
                    ...
                    if (getView().viewportwidth <= 1024 && layer[key] != tmp) _view = false;
                    if (_view) {
