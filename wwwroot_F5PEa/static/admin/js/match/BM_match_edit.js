function BM_match_edit(_win, _dom, _post) {
    var classname = "BM_match_edit";
    var _self = this;
    var win = _win;
    var dom = _dom;
    var parentClass;
    ...
    var status = 0;
    var aryType = Array("GMH2", "GMH3", "GMH4", "GMH5", "GMH6", "GMH7", "GMH8", "GMH1", "GMH");
    ...
    _self.parseData = function (obj) {
        ...
        var score_type = Array("GMH2", "GMH3", "GMH4", "GMH5", "GMH6", "GMH7", "GMH8", "GMH1", "GMH");
        for (var i = 0; i < score_type.length; i++) {
            tpl.addBlock("game");
            var time_slot = LS.get("str_BMTT_" + i);
            if(score_type[i] == "GMH"){
                var time_slot = LS.get("str_BMTT_9");
            }
