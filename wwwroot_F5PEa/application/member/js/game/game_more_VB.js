function game_more_VB(_win, _dom, _post) {
                var classname = "game_more_VB";
                var _self = this;
                var win = _win;
                var dom = _dom;
                var postHash = _post;
                ...
                _self.parseNoGameScoreBoard = function(obj) {
                    ...
                    if (showtype == "live") {
                        ...
                        if (sc_game_H == "") {
                            get("box_sco_vb").style.display = "none";
                            get("box_sco_point").style.display = "none"
                        } else {
                            get("box_sco_vb").style.display = "";
                ...
                _self.parseScoreBoard = function(obj) {
                    try {
                        ...
                        if (obj.showtype == "live")
                            if (obj.gopen == "N" && obj.Live == "N") {
                                ...
                                if (se_now >= obj.max_set && obj.max_set > 0)
                                    se_now = obj.max_set;
                                var se_now_num = se_now + 2;
                                var sc_now_H = obj.scoreObj[set_ary[se_now - 1].toUpperCase() + "_H"];
                                var sc_now_A = obj.scoreObj[set_ary[se_now - 1].toUpperCase() + "_A"];
                                if (sc_now_H > max_sc || sc_now_A > max_sc)
                                    if (sc_now_H - sc_now_A == "2" || sc_now_A - sc_now_H == "2") {
                                        sc_now_H = 0;
                                        sc_now_A = 0;
                                        show_num = "1"
                                    }
                                if (sc_now_H == max_sc || sc_now_A == max_sc && sc_now_H != sc_now_A)
                                    if (sc_now_H - sc_now_A > 2 || sc_now_A - sc_now_H > 2) {
                                        sc_now_H = 0;
                                        sc_now_A = 0;
                                        show_num = "1"
                                ...
                                if (se_now == obj.max_set) {
                                    if (sc_now_H > 15 || sc_now_A > 15)
                                        if (sc_now_H - sc_now_A == "2" || sc_now_A - sc_now_H == "2") {
                                            sc_now_H = 0;
                                            sc_now_A = 0;
                                            show_num = "1"
                                        }
                                    if (sc_now_H == "15" || sc_now_A == "15" && sc_now_H != sc_now_A)
                                        if (sc_now_H - sc_now_A >= 2 || sc_now_A - sc_now_H >= 2) {
                                            sc_now_H = 0;
                                            sc_now_A = 0;
                                            show_num = "1"
                                ...
                                for (var t = 0; t < set_ary.length; t++) {
                                    var _name = set_ary[t];
                                    var sc_H = obj.scoreObj[_name.toUpperCase() + "_H"] * 1;
                                    var sc_A = obj.scoreObj[_name.toUpperCase() + "_A"] * 1;
                                    if (t == 5) {
                                        sc_H = 0;
                                        sc_A = 0
                                    }
                                    if (obj.max_set == "5")
                                        if (se_now == "5" && show_num != "")
                                            se_now = 6;
                                    if (obj.max_set == "3")
                                        if (se_now == "3" && show_num != "")
                                            se_now = 4;
                                ...
                                if (se_now > obj.max_set)
                                    se_now = obj.max_set;
                                set_name = util_game.showTxt(obj.LS_game.get("VB_" + se_now + "_nowPlay")) + " / " + util_game.showTxt(obj.max_set);
                        ...
                        console.log("parseScoreBoard_VB error", e)
                    }
                }
                ;
                function get(_id) {
