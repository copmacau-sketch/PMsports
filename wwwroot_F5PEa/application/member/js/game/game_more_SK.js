 function game_more_SK(_win, _dom, _post) {
                var classname = "game_more_SK";
                var _self = this;
                var win = _win;
                var dom = _dom;
                var postHash = _post;
                ...
                _self.getRtypeRB = function() {
                    ...
                    for (var i = 1; i <= 35; i++) {
                        ...
                        if (i < 10)
                            tmpKey += "0";
                        tmpKey += i;
                        ary["RF" + tmpKey] = new Array("RF" + tmpKey + "H","RF" + tmpKey + "C")
                    }
                    return ary
                }
                ;
                ...
                _self.getRtypeFT = function() {
                    ...
                    ary["F01"] = new Array("F01H","F01C");
                    ary["F02"] = new Array("F02H","F02C");
                    return ary
                }
                ;
                ...
                _self.parseNoGameScoreBoard = function(obj) {
                    ...
                    if (showtype == "live") {
                        ...
                        get("set_name").innerHTML = util_game.showTxt(obj.def_retime)
                    }
                }
                ;
                _self.setScoreBoard = function(mainGame, showtype, gopen, Live, OuterOpen, LS_game, scoreObj) {
                    if (mainGame != null) {
                        ...
                        var best_mode = mainGame["BEST_MODE"];
                        var mode = best_mode.split(" ");
                        if (scoreObj) {
                            score_h = scoreObj["SC_GAME_H"];
                            score_c = scoreObj["SC_GAME_A"]
                        }
                    ...
                    try {
                        ...
                        if (obj.showtype == "live")
                            if (obj.gopen == "N" && obj.Live == "N") {
                                ...
                                set_name = util_game.showTxt(obj.LS_game.get("SK_" + obj.mode[0] + "_" + obj.best));
                            ...
                            if (get("set_name")) {
                                ...
                                get("set_name").innerHTML = util_game.showTxt(obj.LS_game.get("SK_" + obj.mode[0] + "_" + obj.best))
                            }
                        }
                    } catch (e) {
                        console.log("parseScoreBoard_SK error", e)
                    }
                }
                ;
                function get(_id) {
