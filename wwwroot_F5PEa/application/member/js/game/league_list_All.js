									...
									if(obj){
										...
										if(_gid !=null && ECID !=null && nowRtype !=null){
											...
											if(top.choice_gtype!="ft"){ //改OP
												//chg_ior = nowGameHash["ec"+ECID][str_ms.toUpperCase()+util_game.switchWtypeStr(_wtype)]["IOR_"+iorRtype];
												...
												//console.log("[_wtype:"+_wtype+"][iorRtype:"+iorRtype+"][PLAYS_KEY:"+str_ms.toUpperCase()+util_game.switchWtypeStr(_wtype)+"]chg_ior:",chg_ior);
											}
