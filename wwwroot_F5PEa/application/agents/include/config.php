...
$app_contorller =  "agents";
$langx = isset($_POST["langx"]) ? $_POST["langx"] : "zh-cn";
define('VIEW',ROOT_PATH."/view/".$app_contorller."/".$langx);//模板文件夹
define('STATICS',ROOT_PATH."/static/".$app_contorller);//static 文件夹
define('VENDOR',ROOT_PATH."/vendor");//vendor 文件夹
include_once VENDOR."/admin.config.php";
